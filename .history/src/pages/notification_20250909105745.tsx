...
const NotificationList: FC = () => {
  ...
  <ListRenderer
    ...
    renderLeft={(item) => (
      <Box
        className="flex items-center b space-x-2 p-3 rounded-sm shadow-md transform transition-transform duration-300 hover:shadow-blue-500/40 hover:-translate-x-1 hover:scale-105"
      >
