...
return (
  <Box className="bg-background grid grid-cols-2 gap-5 p-1">
    {productsByCategory.map((product) => (
      <Box
        key={product.id}
        className="overflow-hidden bg-white border border-blue-200 p-2 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 transform transition-all duration-300"
      >
