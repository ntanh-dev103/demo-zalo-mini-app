...
export const CartItems: FC = React.memo(() => {
  ...
  itemClassName="
    ...
    hover:bg-blue-50 hover:shadow-sm hover:border-blue-300 
  ...
  renderRight={(item) => (
    <Box flex className="flex-1 justify-between items-center overflow-hidden">
      {/* Product info */}
      <Box className="space-y-0.5 flex-1 pr-3 overflow-hidden">
        <Text size="xxxSmall" className="font-medium text-gray-800 truncate">
          {item.product.name}
        </Text>
        <Text size="xxSmall" className="text-gray-500 truncate">
