        ...
        <ProductPicker product={editingItem?.product} selected={editingItem}>
          {({ open }) => (
            <ListRenderer
              ...
              limit={5}
              onClick={() => {}}
              itemClassName="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-2 min-h-[70px] hover:bg-gray-50 hover:shadow-md transition-all duration-200 w-full"
