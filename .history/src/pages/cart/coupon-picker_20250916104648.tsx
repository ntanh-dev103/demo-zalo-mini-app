...
export const CouponPicker: FC = () => {
  ...
  return (
    <>
      ...
      >
        <Text className="text-primary font-medium size-small">{selected ? selected.code : "Chọn mã khuyến mãi"}</Text>
        <Icon icon="zi-chevron-right" className="text-gray-500" />
      </Box>

      {/* Popup sheet without gray mask */}
      <Sheet
        visible={open}
        onClose={() => setOpen(false)}
        mask={false} // 👈 disable gray background
      >
