    ...
    <Box className="px-4 pt-4 pb-24 space-y-6 border-t border-primary">
      ...
      <Box className="bg-white rounded-lg shadow-sm border border-primary">
        ...
        <ListRenderer
          items={[
            {
              ...
              right: (
                <Box flex className="space-x-2 flex-none">
                  <LocationPicker />
                </Box>
              ),
            },
          ...
          limit={6}
          itemClassName="w-full min-h-[60px] overflow-hidden p-5 mb-3 bg-white rounded-lg shadow-sm border border-gray-200 hover:scale-[1.01] hover:shadow-md z-10 transition-all duration-200"
