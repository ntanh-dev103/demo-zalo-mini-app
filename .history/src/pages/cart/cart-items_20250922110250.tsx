...
import { cartState, selectedCartItemsState, couponState } from "state"; // Added couponState
...
export const CartItems: FC = React.memo(() => {
  ...
  const coupon = useRecoilValue(couponState); // Added to access coupon
                ...
                >
                  ...
                  <Box flex className="items-center space-x-2 shrink-0">
                    ...
                    <Box flex className="items-center space-x-2">
                      {item.product.sale && coupon ? (
                        <>
                          {/* Original price: red with strikethrough */}
                          <Text
                            size="xxSmall"
                            className="font-semibold text-red-600 line-through whitespace-nowrap"
                          >
                          ...
                          >
                            {(() => {
                              const originalPrice = calcFinalPrice(
                                item.product,
                                item.options
                              );
                              const discount =
