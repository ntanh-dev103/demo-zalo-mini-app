    ...
    <Box className="px-4 pt-4 pb-24 space-y-6 border-t border-primary w-full">
      ...
      <Box className="bg-white rounded-xl shadow-md border border-primary">
        ...
        <ListRenderer
          ...
          limit={6}
          itemClassName="flex items-center justify-between gap-3 w-full min-h-[60px] px-4 py-3 mb-2 bg-white rounded-lg shadow-sm hover:bg-blue-50 hover:shadow transition duration-150"
          renderLeft={(item) => (
      ...
      {/* Totals */}
      <Box className="bg-white rounded-xl shadow-md border border-primary p-5 space-y-3">
        ...
        <Box className="flex justify-between border-t border-gray-200 pt-3">
