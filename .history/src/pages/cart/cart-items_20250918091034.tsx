        ...
        <ProductPicker product={editingItem?.product} selected={editingItem}>
          {({ open }) => (
            <ListRenderer
              ...
              limit={5}
              onClick={() => {}}
              itemClassName="bg-white rounded-lg shadow-lg border border-blue-600 mb-3 pb-2 hover:scale-[1.05] transition-transform duration-200"
                ...
                <Box flex className="flex-1 justify-between items-start">
                  ...
                  <Box flex className="items-center space-x-3">
                    <Box flex className="items-center space-x-2">
                      <Button
                        size="small"
                        className="w-7 h-7 min-w-0 rounded-full p-0 flex items-center justify-center bg-gray-200 text-gray-800"
                        onClick={(e) => {
                          e.stopPropagation();
