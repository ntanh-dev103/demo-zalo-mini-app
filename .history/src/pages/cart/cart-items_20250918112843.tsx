    ...
    <Box className="py-3 px-4 pb-24 space-y-4 min-h-fit w-full">
      {cart.length > 0 ? (
        <ProductPicker product={editingItem?.product} selected={editingItem}>
          {({ open }) => (
            <ListRenderer
              ...
              limit={5}
              onClick={() => {}}
              itemClassName="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-2 min-h-[80px] hover:bg-gray-50 hover:shadow-md transition-all duration-200 w-full"
              ...
              renderLeft={(item) => {
                ...
                return (
                  <Box flex className="items-center space-x-3">
                    ...
                    />
                    <img
                      className="w-14 h-14 object-cover rounded-md max-w-full"
              ...
              renderRight={(item) => (
                <Box flex className="flex-1 justify-between items-center">
                  {/* Product info */}
                  <Box className="space-y-1 flex-1 pr-4 max-w-[150px]">
                    <Text
                      size="small"
                  ...
                  {/* Quantity + Price */}
                  <Box flex className="items-center space-x-3 w-[120px]">
        ...
        <Box className="flex items-center justify-center flex-col min-h-[200px] text-center">
          <Text
            className="bg-white border border-gray-200 rounded-lg shadow-sm py-4 px-4 text-gray-500 max-w-[300px]"
            size="small"
          >
