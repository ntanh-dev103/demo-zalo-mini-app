    ...
    <Box className="py-3 px-4 pb-24 space-y-4 min-h-fit w-full">
      {cart.length > 0 ? (
        <ProductPicker product={editingItem?.product} selected={editingItem}>
          {({ open }) => (
            <ListRenderer
              ...
              limit={5}
              onClick={() => {}}
              itemClassName="bg-white rounded-lg shadow-sm border border-blue-400 p-4 mb-2 min-h-[70px] hover:bg-blue-100 hover:shadow-md transition-all duration-200 w-full"
        ...
        <Box className="text-center">
          <Text
            className="bg-white border border-gray-200 rounded-lg shadow-sm py-6 px-4 text-gray-500"
            size="small"
          >
