...
export const CartPreview: FC = () => {
  ...
  return (
    <Box className="sticky bottom-0 left-0 right-0 bg-background border-t border-primary w-full z-50">
      <Box
        flex
        className="px-4 py-3 mx-auto flex items-center justify-between gap-4"
      >
        <Box
          flex
