...
export const Delivery: FC = () => {
  ...
  return (
    <Box className="px-4 pt-4 pb-24 space-y-6 border-t border-primary min-h-fit w-full">
      {/* Delivery method section */}
      <Box className="mx-4">
        <Box className="bg-white rounded-lg shadow-sm border border-primary w-full space-y-3 gap-2">
        ...
        {/* Totals section */}
        <Box className="bg-white rounded-lg shadow-sm border border-primary p-5 space-y-3 overflow-x-hidden">
