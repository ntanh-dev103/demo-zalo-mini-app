...
import { shippingMethodState, totalPriceState, totalPriceWithShippingState } from "state";

export default function Transportation() {
  const [shipping, setShipping] = useRecoilState(shippingMethodState);
  const [totalPrice, setTotalPrice] = useRecoilState(totalPriceWithShippingState);
