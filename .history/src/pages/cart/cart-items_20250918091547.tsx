...
export const CartItems: FC = React.memo(() => {
  ...
  console.log("CartItems rendered"); // Debug log for white screen
        ...
        <ProductPicker product={editingItem?.product} selected={editingItem}>
          {({ open }) => (
            <ListRenderer
              ...
              limit={5}
              onClick={() => {}}
              itemClassName="bg-white rounded-lg shadow-sm border border-blue-600 p-5 mb-3 hover:scale-[1.05] hover:shadow-lg hover:bg-blue-100 z-10 transition-all duration-250"
                ...
                return (
                  <Box flex className="items-start space-x-3">
                    <input
                      ...
                      className="
                        w-5 h-5 rounded-[4px] border border-primary 
              ...
              renderRight={(item) => (
                <Box flex className="flex-1 justify-between items-start">
                  ...
                  <Box className="space-y-1 flex-1 pr-4">
                    <Text size="xSmall" className="font-semibold text-primary">
                      {item.product.name}
                    </Text>
                  ...
                  <Box flex className="items-center space-x-3">
                    <Box flex className="items-center space-x-2">
                      <Button
                        size="small"
                        className="w-7 h-7 min-w-0 rounded-full p-0 flex items-center justify-center bg-gray-200 text-gray-800 hover:bg-gray-300"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <Text className="text-primary font-medium" size="xSmall">
                        {item.quantity}
                      </Text>
                      <Button
                        size="small"
                    ...
                    <Text className="font-semibold text-green" size="xSmall">
