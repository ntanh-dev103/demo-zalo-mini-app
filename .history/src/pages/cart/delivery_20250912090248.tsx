    ...
    <Box className="space-y-3 px-4 pt-4 pb-20">
      ...
      <ListRenderer
        items={[
          ...
          {
  left: <Icon icon="zi-clock-1" className="my-auto" />, // or any truck-like icon
  right: (
    <Box className="flex flex-col w-full space-y-2">
      ...
      >
        <Box>
          <Text size="large" className="text-blue-400 font-medium">
      ...
      >
        <Box>
          <Text size="large" className="text-blue-700 font-medium">
            Giao hàng nhanh
          </Text>
          <Text size="xSmall" className="text-gray">
            30.000đ
