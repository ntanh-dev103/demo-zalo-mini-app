        ...
        <ProductPicker product={editingItem?.product} selected={editingItem}>
          {({ open }) => (
            <ListRenderer
              ...
              limit={5}
              onClick={() => {}}
              itemClassName="bg-white rounded-lg shadow-sm border border-blue-600 p-5 mb-3 hover:scale-[1.05] hover:shadow-lg bg-blue-300 z-10 transition-all duration-250"
