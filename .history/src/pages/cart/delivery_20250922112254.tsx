...
export const Delivery: FC = () => {
  ...
  return (
    <Box className="px-4 pt-4 pb-24 space-y-6 border-t border-primary min-h-fit overflow-x-hidden">
      {/* Delivery method section */}
      <Box className="bg-white rounded-lg shadow-sm border border-primary overflow-x-hidden">
      ...
      <Box className="bg-white rounded-lg shadow-sm border border-primary p-5 space-y-2 overflow-x-hidden">
        ...
        <Text className="font-bold text-lg mt-2 pt-2 border-t border-gray text-primary">
          Tổng thanh toán: <DisplayPrice>{totals.total}</DisplayPrice>
        </Text>
      </Box>
    </Box>
  );
