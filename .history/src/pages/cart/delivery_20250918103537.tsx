      ...
      <Box className="bg-white rounded-lg shadow-sm border border-primary">
        ...
        <ListRenderer
          ...
          onClick={(item, index) => {
            ...
            switch (index) {
              case 0:
                // LocationPicker handles its own onClick
                console.log("LocationPicker clicked");
                break;
              case 1:
                setTimeVisible(true);
                ...
                break;
              case 2:
                // RequestPersonPickerPhone handles its own onClick
                console.log("RequestPersonPickerPhone clicked");
                break;
              case 3:
                setCouponVisible(true);
                console.log("CouponPicker clicked");
                break;
              case 4:
                // Transportation handles its own onClick
                console.log("Transportation clicked");
                break;
              case 5:
                // ElasticTextarea click logged, no picker needed
                console.log("ElasticTextarea clicked");
                break;
            }
          }}
        />
