    ...
    <Box className="px-4 pt-4 pb-24 space-y-6 border-t border-primary">
      ...
      <Box className="bg-white rounded-lg shadow-sm border border-primary">
        ...
        <ListRenderer
            ...
            },
            {
              ...
              right: (
                <Box flex className="justify-between space-x-2 flex-none">
                  <Box className="flex-1 w-full">
                    <Transportation />
                    {console.log("Transportation rendered")} {/* Debug log */}
                  </Box>
                  <Icon icon="zi-chevron-right" className="my-auto text-gray-500" />
                </Box>
              ),
          ...
          limit={6}
          itemClassName="w-full min-h-[60px] overflow-hidden p-5 mb-3 bg-white rounded-lg shadow-sm hover:scale-[1.01] hover:shadow-md z-10 transition-all duration-200"
