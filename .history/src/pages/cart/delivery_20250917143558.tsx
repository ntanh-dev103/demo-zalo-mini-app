...
export const Delivery: FC = () => {
  ...
  <Text className="font-medium text-primary">Thành tiền: {totals.subtotal.toLocaleString()}₫</Text>
  ...
  <Text className="text-red-500 font-medium">Phí vận chuyển: {totals.shippingFee.toLocaleString()}₫</Text>
