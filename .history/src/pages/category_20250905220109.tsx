...
const CategoryPage: FC = () => {
  return (
    <Page className="flex flex-col bg-background">
      ...
      />
      <Box className="shadow-md overflow-hidden bg-white border border-blue-200 p-2 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-110 transform transition-all duration-200">
        <CategoryPicker />
      </Box>
    </Page>
  );
