...
const NotificationList: FC = () => {
  ...
  <ListRenderer
    ...
    renderLeft={(item) => (
      <Box
        className="flex items-center space-x-3 p-0 rounded-sm shadow-md bg-white transform transition-transform duration-300 hover:shadow-blue-500/40 hover:scale-105"
      >
