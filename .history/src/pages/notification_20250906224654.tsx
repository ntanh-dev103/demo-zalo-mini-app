...
const NotificationList: FC = () => {
  ...
  <ListRenderer
    ...
    renderLeft={(item) => (
      <Box
        className="flex items-center space-x-3 p-3 rounded-lg shadow-md bg-white transform transition-transform duration-300 hover:scale-105 hover:shadow-lg"
      >
        <img className=" h-10 rounded-full" src={item.image} />
