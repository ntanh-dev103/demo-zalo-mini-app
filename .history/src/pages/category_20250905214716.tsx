...
const CategoryProducts: FC<{ categoryId: string }> = ({ categoryId }) => {
  ...
  return (
    <Box className="overflow-hidden bg-white border border-blue-200 p-2 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-110 transform transition-all duration-300">
